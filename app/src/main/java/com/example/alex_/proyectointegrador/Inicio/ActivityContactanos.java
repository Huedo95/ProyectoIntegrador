...
public class ActivityContactanos extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
//NAV_DRAWER
    ...
    private AdaptadorContactanos miAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //RECYCLERVIEW
        datos = (new DatosContactanos()).getLista();
        miRecyclerView = (RecyclerView)findViewById(R.id.rv_contacto);
        ...
        miAdapter = new AdaptadorContactanos(datos);
